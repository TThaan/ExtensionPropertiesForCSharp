...
namespace ExtensionPropertiesForCSharp
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //
            ref EgStruct sXT = ref ExtensionOf(new EgStruct() { z = 14 }, "sXT");

            //          or:

            EgClass egClass = new EgClass() { x = 10, y = 77 };
            ref EgClass cXT = ref ExtensionOf(egClass, "cXT");
        ...
        static void DoubleThis(ref EgStruct iXT)
        {
            iXT.z *= 2;
        }
